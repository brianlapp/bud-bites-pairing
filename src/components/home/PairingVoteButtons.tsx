  ...
  return (
    <div className="flex justify-between items-center pt-6 border-t border-sage-100">
      <button
        ...
        className="flex items-center gap-2.5 px-4 py-2 rounded-lg hover:bg-sage-50 transition-colors duration-200 group"
      >
        <ThumbsUp className="w-5 h-5 text-sage-500 group-hover:text-coral-500 transition-colors duration-200" />
      ...
      <button
        ...
        className="flex items-center gap-2.5 px-4 py-2 rounded-lg hover:bg-sage-50 transition-colors duration-200 group"
      >
        <ThumbsDown className="w-5 h-5 text-sage-500 group-hover:text-coral-500 transition-colors duration-200" />
        <span className="text-sm font-medium text-sage-500 group-hover:text-coral-500 transition-colors duration-200">
          {notHelpfulVotes}
        </span>
      </button>
