        ...
        <div className="relative">
          ...
          <div className="absolute top-0 left-0 w-full overflow-hidden z-10">
            <svg
              ...
              className="relative block w-full h-[60px] text-sage-50"
            >
          ...
          <div className="container mx-auto px-4 py-8">
            <div className="max-w-4xl mx-auto mb-12 text-center">
              <h2 className="text-2xl font-semibold text-sage-500 mb-4">How to Use the Budget Planner</h2>
              <div className="grid md:grid-cols-3 gap-6 text-left">
                <div className="p-4 rounded-lg bg-white shadow-sm border border-sage-200">
                  <div className="text-coral-500 mb-2 text-xl">1️⃣</div>
                ...
                <div className="p-4 rounded-lg bg-white shadow-sm border border-sage-200">
                  <div className="text-coral-500 mb-2 text-xl">2️⃣</div>
                ...
                <div className="p-4 rounded-lg bg-white shadow-sm border border-sage-200">
                  <div className="text-coral-500 mb-2 text-xl">3️⃣</div>
