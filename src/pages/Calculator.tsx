        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6">
              ...
              <p className="text-sage-100">Input your weight and select your preferred unit of measurement (kg/lbs).</p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6">
              <h3 className="text-xl font-semibold mb-2">2. Set Preferences</h3>
              <p className="text-sage-100">Choose your tolerance level and preferred consumption method.</p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6">
              <h3 className="text-xl font-semibold mb-2">3. Get Results</h3>
              <p className="text-sage-100">Receive a personalized dosing recommendation with safety tips.</p>
            </div>
          </div>
        </div>
